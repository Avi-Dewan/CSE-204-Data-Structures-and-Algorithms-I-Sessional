...
public class DishWasher_1R2S {
    ...
    public static void main(String[] args) {
        ...
        DishWash[] allocArr = new DishWash[n*x];

//        System.out.println("l = " + allocArr.length);


        AStack<DishWash> dirtyStack = new AStack<>(allocArr, 1);
        AStack<DishWash> cleanStack = new AStack<>(allocArr, -1);
